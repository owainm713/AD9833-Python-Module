"""AD9833, python module to use the AD983X
...
class AD9833:
    ...
    def set_write_mode(self, writeMode = 'BOTH'):
        """set_write_mode, function to set the B28 and HLB buts in the
